...
let CreateExhibitionArrangeComponent = class CreateExhibitionArrangeComponent {
    constructor(createService, galleryService) {
        this.createService = createService;
        this.galleryService = galleryService;
        this.selectedArrayPosition = -1;
        this.selectedId = "-1";
    ...
    resetPositionConfig(exhibitList) {
        const tempPositionConfigList = [];
    ...
    isMaterialSelected(material_id) {
    ...
    automaticallyPlacement() {
        let temp_positionConfigList = this.createService.wizPositionConfigList.getValue();
    ...
    getFilteredRoomPositionsByWall(isWall) {
        return this.room?.positions.filter(position => { return position.is_wall == isWall; }) ?? [];
    }
    getFilteredRoomPositionsByDataType(data_type) {
...
CreateExhibitionArrangeComponent = __decorate([
    Component({
...
export { CreateExhibitionArrangeComponent };
//# sourceMappingURL=create-exhibition-arrange.component.js.map